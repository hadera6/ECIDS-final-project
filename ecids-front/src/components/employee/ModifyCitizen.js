...
import { MDBContainer, MDBRow, MDBCol, MDBBtn, MDBCard, MDBCardBody, 
  MDBInput,MDBNavbar, MDBNavbarBrand, MDBNavbarNav, MDBNavItem, MDBNavLink,
   MDBBreadcrumb, MDBBreadcrumbItem,MDBFormInline, MDBCardImage, 
   MDBCardTitle, MDBCardText, MDBCardFooter, MDBIcon } from 'mdbreact';
...
class AddCitizen extends React.Component {
  ...
  submitSearchHandler = event => {
    ...
    axios
    .get("http://localhost:5000/api/displayOneCitizen", {id:this.state.id})
    .then(res =>alert(res.citize)) // re-direct sto login on successful register
    .catch(err =>
  ...
  changeSearchHandler = event => {
    this.setState({ id : "RHT0634181901-2021" });
  ...
  render() {
    return (
      ...
      <MDBCardBody id="breadcrumb" className="d-flex align-items-center justify-content-between">
          <MDBBreadcrumb>
              <MDBBreadcrumbItem>Update</MDBBreadcrumbItem>
          </MDBBreadcrumb>
          <MDBFormInline className="md-form m-0" onSubmit= {this.submitSearchHandler}>
